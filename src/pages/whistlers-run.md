...
All images throughout the website are configurd and served through an image transformation service called [Imagekit.io](https://imagekit.io/). Imagekit automatically handles all images that are uploaded to the website, resizes them and transforms them into modern image formats like AVIF and WEBP.
